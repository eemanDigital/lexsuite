  ...
  return (
    <main className="relative overflow-hidden">
      ...
      <section className="relative bg-navy text-white min-h-[90vh] flex items-center overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(0,216,204,0.18),_transparent_26%),radial-gradient(circle_at_80%_15%,_rgba(70,240,231,0.14),_transparent_18%)] opacity-80" />
        <div className="absolute inset-0 bg-gradient-to-br from-[#001d45]/95 via-[#002b5f]/90 to-[#002050]/100" />

        <div className="pointer-events-none absolute -top-10 right-10 h-72 w-72 rounded-full bg-gold/10 blur-3xl" />
        <div className="pointer-events-none absolute bottom-10 left-10 h-72 w-72 rounded-full bg-gold/15 blur-2xl" />

        {/* Geometric wireframe — full-width bottom-anchored cyan tessellation with glow */}
        <div
          className="absolute bottom-0 left-0 w-full h-[42%] pointer-events-none overflow-hidden"
          aria-hidden>
          <svg
            ...
            <g stroke="#00d8cc" strokeWidth="0.5" opacity="0.08">
            ...
            <g stroke="#00d8cc" strokeWidth="1" opacity="0.25">
              ...
              {/* internal lines */}
              <line x1="72" y1="170" x2="144" y2="212" />
              <line x1="144" y1="212" x2="144" y2="294" />
              <line x1="144" y1="294" x2="72" y2="336" />
              <line x1="72" y1="336" x2="0" y2="294" />
              <line x1="0" y1="294" x2="0" y2="212" />
              <line x1="0" y1="212" x2="72" y2="170" />
              <line x1="72" y1="170" x2="72" y2="336" />
              <line x1="0" y1="212" x2="144" y2="212" />
              <line x1="0" y1="294" x2="144" y2="294" />
              <line x1="36" y1="253" x2="108" y2="253" />
            </g>

            {/* Bottom row — boldest foreground mesh */}
            <g stroke="#00d8cc" strokeWidth="1.5" opacity="0.4">
              <polygon points="72,320 144,362 144,444 72,486 0,444 0,362" />
              <polygon points="216,320 288,362 288,444 216,486 144,444 144,362" />
              <polygon points="360,320 432,362 432,444 360,486 288,444 288,362" />
              <polygon points="504,320 576,362 576,444 504,486 432,444 432,362" />
              ...
              <polygon points="1224,320 1296,362 1296,444 1224,486 1152,444 1152,362" />
              <polygon points="1368,320 1440,362 1440,444 1368,486 1296,444 1296,362" />
              <line x1="72" y1="320" x2="144" y2="362" />
              <line x1="144" y1="362" x2="144" y2="444" />
              <line x1="144" y1="444" x2="72" y2="486" />
              <line x1="72" y1="486" x2="0" y2="444" />
              <line x1="0" y1="444" x2="0" y2="362" />
              <line x1="0" y1="362" x2="72" y2="320" />
              <line x1="72" y1="320" x2="72" y2="486" />
              <line x1="0" y1="362" x2="144" y2="362" />
              <line x1="0" y1="444" x2="144" y2="444" />
            </g>

            {/* GLOWING edges — highlighted hexagons */}
            <g stroke="#00d8cc" strokeWidth="2.5" filter="url(#glow)">
              <polygon points="360,320 432,362 432,444 360,486 288,444 288,362" />
              <polygon points="792,320 864,362 864,444 792,486 720,444 720,362" />
            ...
            <g filter="url(#glow)">
              <circle cx="360" cy="320" r="4" fill="#00d8cc" opacity="1" />
              <circle cx="360" cy="486" r="3.5" fill="#00d8cc" opacity="0.9" />
              <circle cx="792" cy="320" r="4" fill="#00d8cc" opacity="1" />
              <circle cx="792" cy="486" r="3.5" fill="#00d8cc" opacity="0.9" />
              <circle cx="648" cy="320" r="3" fill="#00d8cc" opacity="0.8" />
              <circle cx="1080" cy="320" r="3" fill="#00d8cc" opacity="0.8" />
            </g>
            <circle
              cx="360"
              cy="320"
            ...
            <g fill="#00d8cc" opacity="0.5">
              <circle cx="72" cy="320" r="2" />
              <circle cx="144" cy="362" r="2" />
              <circle cx="144" cy="444" r="2" />
              <circle cx="72" cy="486" r="2.5" />
              <circle cx="0" cy="444" r="2" />
              <circle cx="0" cy="362" r="2" />
              <circle cx="216" cy="320" r="2" />
              <circle cx="288" cy="362" r="2" />
              <circle cx="288" cy="444" r="2" />
              <circle cx="432" cy="362" r="2" />
              <circle cx="432" cy="444" r="2" />
              <circle cx="504" cy="320" r="2" />
              <circle cx="576" cy="362" r="2" />
              <circle cx="576" cy="444" r="2" />
              <circle cx="720" cy="362" r="2" />
              <circle cx="720" cy="444" r="2" />
              <circle cx="864" cy="362" r="2" />
              <circle cx="864" cy="444" r="2" />
              <circle cx="936" cy="320" r="2" />
              <circle cx="1008" cy="362" r="2" />
              <circle cx="1008" cy="444" r="2" />
              <circle cx="1152" cy="362" r="2" />
              <circle cx="1152" cy="444" r="2" />
              <circle cx="1224" cy="320" r="2" />
              <circle cx="1296" cy="362" r="2" />
              <circle cx="1296" cy="444" r="2" />
              <circle cx="1368" cy="320" r="2" />
              <circle cx="1440" cy="362" r="2" />
              <circle cx="1440" cy="444" r="2" />
            </g>

            {/* Bottom gradient blend */}
            <defs>
              <linearGradient id="fadeBottom" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="#001226" stopOpacity="0" />
                <stop offset="100%" stopColor="#001226" stopOpacity="0.25" />
              </linearGradient>
            </defs>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <div className="flex gap-10">
              <div className="text-center">
                ...
                <p className="text-sm font-bold text-text-dark">Leading Firm<br />Nigeria</p>
              </div>
              <div className="text-center">
                <Award size={48} className="mx-auto text-navy" strokeWidth={1.2} />
      ...
      {/* <section className="relative bg-navy py-20">
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center sm:px-8">
          ...
          <blockquote className="text-2xl font-serif leading-relaxed text-white sm:text-3xl">
            &ldquo;The team have developed a deep understanding of our business
            operations and consistently deliver practical, commercially-aware
            advice.&rdquo;
          </blockquote>
      ...
      <section className="relative overflow-hidden py-24">
        {/* Silk gradient base */}
        <div className="absolute inset-0 bg-gradient-to-br from-off-white via-white to-gold/[0.02]" />

        {/* Flowing silk orbs */}
        <div className="absolute -top-48 -right-48 h-[600px] w-[600px] rounded-full bg-gradient-to-br from-gold/15 via-gold/5 to-transparent blur-3xl" />
        <div className="absolute -bottom-48 -left-48 h-[500px] w-[500px] rounded-full bg-gradient-to-tr from-gold/10 via-accent-blue/[0.03] to-transparent blur-3xl" />
        <div className="absolute top-1/3 left-1/4 h-[300px] w-[300px] rounded-full bg-gradient-to-r from-gold/8 to-transparent blur-3xl" />
        <div className="absolute bottom-1/4 right-1/3 h-[250px] w-[250px] rounded-full bg-gradient-to-l from-gold/6 to-transparent blur-3xl" />
        ...
        <svg
          className="absolute top-0 left-0 w-full h-32 text-gold/5"
          preserveAspectRatio="none"
          viewBox="0 0 1440 120"
          fill="currentColor">
          <path d="M0,40 C360,120 720,0 1440,60 L1440,0 L0,0 Z" />
        </svg>

        {/* Decorative flowing curve — bottom */}
        <svg
          className="absolute bottom-0 left-0 w-full h-32 text-gold/[0.04]"
          preserveAspectRatio="none"
          viewBox="0 0 1440 120"
          fill="currentColor">
          <path d="M0,80 C360,0 720,120 1440,40 L1440,120 L0,120 Z" />
        </svg>

        <div className="relative mx-auto max-w-4xl px-6 sm:px-8">
          <ScrollReveal>
            <p className="text-xl leading-relaxed text-text-dark font-semibold sm:text-2xl">
              You&apos;re looking for a commercial lawyer. You&apos;re a
              high-growth startup or an established business navigating
              Nigeria&apos;s digital economy. You need legal advice that
              understands both the law and the technology powering your
              products.
            </p>
      ...
      <section className="relative bg-white py-20 lg:py-28 overflow-hidden">
        ...
        <div
          className="hidden lg:block absolute left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-gold/40 to-transparent"
          aria-hidden
        />
        <div
          className="hidden lg:block absolute left-[45%] top-1/3 w-[15%] h-px bg-gradient-to-r from-gold/40 to-transparent"
          aria-hidden
        />
        ...
        <div className="relative mx-auto max-w-7xl px-6 sm:px-8">
          <div className="grid items-center gap-14 lg:grid-cols-2 lg:gap-20">
            ...
            <ScrollReveal direction="left" className="relative">
              ...
              <p className="mt-4 text-base leading-relaxed text-text-dark font-medium sm:text-lg max-w-xl">
              ...
              <div className="mt-8">
                <Link
                  href="/about"
                  className="inline-flex items-center gap-2 rounded-full bg-navy px-7 py-3.5 text-sm font-semibold text-white transition hover:bg-[#3D3D3D]">
                  Learn More About Us
            ...
            <ScrollReveal direction="right" className="relative">
              ...
              <div
                className="absolute -top-6 -right-6 h-72 w-72 rounded-full bg-gold/5 blur-3xl"
                aria-hidden
              />
              <div
                className="absolute -bottom-6 -left-6 h-48 w-48 rounded-full bg-navy/5 blur-2xl"
                aria-hidden
              />
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-8">
          <div className="mb-10 text-center">
            <h2 className="text-3xl font-bold text-navy">
              Responsive, Personal and Efficient
            </h2>
          </div>
          <div className="flex gap-6 overflow-x-auto pb-4 scrollbar-none">
            {practiceAreas.map((area) => (
              <div
                ...
                <span className="whitespace-nowrap text-xs font-semibold text-text-dark">
                  {area.label}
                </span>
              </div>
            ))}
