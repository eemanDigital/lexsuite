    ...
    <footer className="bg-navy text-white">
      ...
      <div className="h-52 w-full relative overflow-hidden bg-navy-mid">
        <iframe
          ...
          title="ATL Solicitors - Abuja Office"
        />
          ...
          <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
            <div>
              ...
              <p className="mt-1 text-sm text-grey-400">
                Insights on AI, privacy and startup law in Nigeria.
              </p>
            </div>
            <form
      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-12 sm:px-8 lg:grid-cols-[1.4fr_1fr_1fr_1fr]">
        <div className="space-y-5">
          ...
          <p className="text-xs text-grey-500">
            ATL Solicitors · Registered with the Nigerian Bar Association ·
            CAC Accredited
          </p>
        </div>

        <div>
          <h3 className="mb-4 text-sm font-semibold uppercase tracking-wider text-grey-400">
            ATL
          </h3>
          <div className="space-y-3 text-sm text-grey-400">
            <Link href="/" className="block transition hover:text-gold">
              Home
            </Link>
            <Link href="/services" className="block transition hover:text-gold">
              Practice Areas
            </Link>
            <Link href="/about" className="block transition hover:text-gold">
              About Us
            </Link>
            <Link href="/team" className="block transition hover:text-gold">
              Team
            </Link>
            <Link href="/blog" className="block transition hover:text-gold">
              Insights
            </Link>
            <Link href="/contact" className="block transition hover:text-gold">
              Contact
            </Link>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-6 flex items-center gap-4">
            <Link
              href="https://linkedin.com/company/lexsuite"
              aria-label="LinkedIn"
              className="transition hover:text-gold">
              <Linkedin size={18} />
            </Link>
            <Link
              href="https://twitter.com/ATLLaw"
              aria-label="Twitter"
              className="transition hover:text-gold">
              <Twitter size={18} />
            </Link>
        ...
        <div className="mx-auto max-w-7xl px-6 py-6 sm:px-8">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            <div className="flex items-center gap-4">
              <span className="inline-flex rounded border border-white/10 bg-white/5 px-3 py-1 text-xs text-grey-400">
                Cyber Essentials
              </span>
              <span className="inline-flex rounded border border-white/10 bg-white/5 px-3 py-1 text-xs text-grey-400">
                NBA Registered
            ...
            <p className="text-xs text-grey-500">
              © {new Date().getFullYear()} ATL Solicitors. All rights
              reserved.
            </p>
          </div>
        </div>
