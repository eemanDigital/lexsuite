    ...
    <div className="mx-auto max-w-7xl px-6 sm:px-8">
      <div className="mb-10 text-center">
        ...
        <h2 className="mt-3 text-3xl font-bold text-navy">
          Our solicitors and support staff
        </h2>
      </div>
      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
        {team.map((t) => (
          <div key={t.name} className="group text-center">
            ...
            <h3 className="mt-4 text-lg font-semibold text-navy underline decoration-transparent transition group-hover:decoration-gold">
              {t.name}
            </h3>
